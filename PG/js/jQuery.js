...
$(document).ready(function () {
  ...
  $links.on('click', function (e) {
    ...
    // $submenu.show(); // only shows block (display: block)
    // $submenu.css('display', 'block'); // same behavior as previous line
    // $submenu.toggle(); // switcher (display: block/display: none)
    $submenu.slideToggle(); // animated version
  });
