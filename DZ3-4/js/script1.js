...
/*createPage.createTitle('Тест по программированию');

	for (var i = 1; i <=  3; i++) {
		createPage.createQuestion(i+ '. Вопрос № ' +i);
			for (var j = 1; j <= 3; j++) {
		createPage.createAnswer('Вариант ответа №' + j);
	}
	}


createPage.createButton('Проверить мои результаты');*/
